...
class fheKey<QL, degree, w>::cryptoBackends::obliviousTransfer {
public:
...
template<int QL, int degree, uint64_t w>
void fheKey<QL, degree, w>::cryptoBackends::obliviousTransfer::setup(cryptoBackends* backend, int ID) {
...
template<int QL, int degree, uint64_t w>
void fheKey<QL, degree, w>::cryptoBackends::obliviousTransfer::biByteOT(
...
template<int QL, int degree, uint64_t w>
void fheKey<QL, degree, w>::cryptoBackends::obliviousTransfer::biOT(uint64_t* src, uint64_t* dst, unsigned char* choice, size_t size) {
//  printf("biOT %zu\n", size);
...
template<int QL, int degree, uint64_t w>
template<int vecLen>
void fheKey<QL, degree, w>::cryptoBackends::obliviousTransfer::biHeavyOT(uint64_t* src, uint64_t* dst, unsigned char* choice, size_t size) {
  otBackend<3, uint64_t, vecLen>(src, nullptr, dst, nullptr, choice, nullptr,
                         size);
}

template<int QL, int degree, uint64_t w>
void fheKey<QL, degree, w>::cryptoBackends::obliviousTransfer::doubleBiOT(
...
template<int QL, int degree, uint64_t w>
template<typename T>
void fheKey<QL, degree, w>::cryptoBackends::obliviousTransfer::transpose(T* dst, __m128i** src, size_t size) {
...
void fheKey<QL, degree, w>::cryptoBackends::obliviousTransfer::otBackend(
